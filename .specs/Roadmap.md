...
providers appear from the open web, approve a shortlist, receive responses through
email/forms, and compare evidence-backed offers through request-specific views.
...
- No provider is contacted without explicit, versioned user approval.
...
| 4     | [Request intake and requirements](./04-request-intake-and-requirements.md)     | 03         | Prompt becomes editable requirements; user explicitly starts research     |
...
| 6     | [Approval and contact](./06-outreach-approval-and-contact.md)                  | 05         | Versioned approval drives mixed email/form outreach exactly once          |
...
| 9     | [Evaluation and dynamic UI](./09-evaluation-and-dynamic-ui.md)                 | 08         | Multiple trusted lenses and evidence-aware recommendation                 |
...
Passkey sign-in
  ...
  → AgentMail email / Firecrawl form
...
2. **Research checkpoint (Specs 03–05):** a request becomes confirmed requirements
   and a live, evidence-backed shortlist.
3. **Real-world contact checkpoint (Specs 06–08):** approved providers are contacted,
   replies arrive, and proposals normalize safely.
...
- User authorization for outreach and escalation for commitments.
